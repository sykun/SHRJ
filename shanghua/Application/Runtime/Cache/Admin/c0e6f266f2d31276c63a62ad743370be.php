...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/shanghua/index.php/Admin/Indexen/indexen">Home page</a><span class="crumb-step">&gt;</span><span class="crumb-name">Industry list</span></div>
        </div>
        <div class="result-wrap">
            <form name="myform" id="myform" action="/shanghua/index.php/Admin/Industryen/deleteen">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/shanghua/index.php/Admin/Industryen/adden"><i class="icon-font"></i>New information</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        <tr>
                            ...
                            <th width="20%">Map information</th>
                            <th width="20%">Information title</th>
                            <th width="20%">Information content</th>
                            <th width="13%">Add time</th>
                            <th width="20%">operation</th>
                        </tr>
                        <?php if(is_array($industryen)): $i = 0; $__LIST__ = $industryen;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            <td><input type="checkbox" name="industryenId[]" id="checkbox" value="<?php echo ($data["id"]); ?>"><label for="checkbox"></label></td>
                            ...
                            <td>
                                <a class="link-update" href="/shanghua/index.php/Admin/Industryen/editen/id/<?php echo ($data["id"]); ?>">modify</a>
                                <a class="link-del" href="/shanghua/index.php/Admin/Industryen/deleteen/industryenId/<?php echo ($data["id"]); ?>">delete</a>
                            </td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                    <div id="alldelete">

                    <button type="submit" id="batchDel" class="btn btn-danger " href="/shanghua/index.php/Admin/Industryen/deleteen">Batch delete</button> 
                     </div>
