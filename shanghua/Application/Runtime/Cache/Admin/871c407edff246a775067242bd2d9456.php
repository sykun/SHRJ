...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/shanghua/index.php/Admin/Indexen/index">Home page</a><span class="crumb-step">&gt;</span><span class="crumb-name">Honor list</span></div>
        </div>
        <div class="result-wrap">
            <form name="myform" id="myform" action="/shanghua/index.php/Admin/Honoren/deleteen">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/shanghua/index.php/Admin/Honoren/adden"><i class="icon-font"></i>Add honor</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        <tr>
                            ...
                            <th width="40%">Certificate of honor</th>
                            <th width="20%">Honor content</th>
                            <th width="12%">Operatio</th>
                        </tr>
                        <?php if(is_array($honoren)): $i = 0; $__LIST__ = $honoren;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            <td><input type="checkbox" name="honorenId[]" id="checkbox" value="<?php echo ($data["id"]); ?>"><label for="checkbox"></label></td>
                            ...
                            <td>
                                <a class="link-update" href="/shanghua/index.php/Admin/Honoren/editen/id/<?php echo ($data["id"]); ?>">Modify</a>
                                <a class="link-del" href="/shanghua/index.php/Admin/Honoren/deleteen/honorenId/<?php echo ($data["id"]); ?>">Delete</a>
                            </td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                    <div id="alldelete">

                    <button type="submit" id="batchDel" class="btn btn-danger " href="/shanghua/index.php/Admin/Honoren/deleteen">Batch delete</button> 
                     </div>
