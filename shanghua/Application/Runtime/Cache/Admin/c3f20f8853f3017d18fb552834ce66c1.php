...
<div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/shanghua/index.php/Admin/Case/doEdit" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th>案例标题：</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="title" size="50" value="<?php echo ($case["title"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>案例配图：</th>
                                <td>
                                <img src="/shanghua/Public/<?php echo ($case["thumb"]); ?>" width="60px" height="60px">
                                <input name="thumb" id="" type="file"><!--<input type="submit" onclick="submitForm('/jscss/admin/design/upload')" value="上传图片"/>--></td>
                            </tr>
                            
                            <tr>
                                <th>案例描述：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($case["content"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
