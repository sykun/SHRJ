...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/shanghua/index.php/Admin/Indexen/index">Home page</a><span class="crumb-step">&gt;</span><span class="crumb-name">Product list</span></div>
        </div>
        <div class="result-wrap">
            <form name="myform" id="myform" action="/shanghua/index.php/Admin/Producten/deleteen">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/shanghua/index.php/Admin/Producten/adden"><i class="icon-font"></i>Add product</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($producten)): $i = 0; $__LIST__ = $producten;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            <td><input type="checkbox" name="productenId[]" id="checkbox" value="<?php echo ($data["id"]); ?>"><label for="checkbox"></label></td>
                            ...
                            <td>
                                <a class="link-update" href="/shanghua/index.php/Admin/Producten/editen/id/<?php echo ($data["id"]); ?>">revise</a>
                                <a class="link-del" href="/shanghua/index.php/Admin/Producten/deleteen/productenId/<?php echo ($data["id"]); ?>">delete</a>
                            </td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                     <div id="alldelete">

                    <button type="submit" id="batchDel" class="btn btn-danger " href="/shanghua/index.php/Admin/Producten/delete">Batch delete</button> 
                     </div>
