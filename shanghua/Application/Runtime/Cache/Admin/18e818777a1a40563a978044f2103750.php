        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="allCategory.html"><i class="icon-font">&#xe017;</i>所有分类<li><a href="addCategory.html"><i class="icon-font">&#xe037;</i>添加分类</a></li>
                    </ul>
                </li>
                <li>
...
<div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Admin/rooms/store');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
