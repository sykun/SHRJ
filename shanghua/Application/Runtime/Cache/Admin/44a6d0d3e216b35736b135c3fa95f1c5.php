...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/shanghua/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/shanghua/index.php/Admin/Success/lists">案例管理</a><span class="crumb-step">&gt;</span><span>添加案例</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/shanghua/index.php/Admin/Successful/doEdit" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                                <th>案例标题：</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="title" size="50" value="<?php echo ($successful["title"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>案例配图：</th>
                            ...
                            <tr>
                                <th>案例描述：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($successful["content"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
