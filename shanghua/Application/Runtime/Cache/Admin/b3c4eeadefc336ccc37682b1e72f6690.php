...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/shanghua/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/shanghua/index.php/Admin/Product/lists">产品管理</a><span class="crumb-step">&gt;</span><span>添加产品</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/shanghua/index.php/Admin/Product/doEdit" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th>产品标题：</th>
                                <td>
                                    <input class="common-text required" id="thumb" name="title" size="50" value="<?php echo ($product["title"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>产品配图：</th>
                                <td>
                                    <img src="/shanghua/Public/<?php echo ($product["thumb"]); ?>" width="60px" height="60px">
                            ...
                            <tr>
                                <th>产品内容描述：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10" ><?php echo ($product["content"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
