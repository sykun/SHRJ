...
<div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/shanghua/index.php/Admin/Advice/delete">
                ...
                <div class="result-content">
                    ...
                    <button type="submit" id="batchDel" class="btn btn-danger " href="/shanghua/index.php/Admin/Advice/delete">批量删除</button> 
                     </div>
