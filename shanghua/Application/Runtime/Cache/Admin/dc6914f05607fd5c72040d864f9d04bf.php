...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/shanghua3/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/shanghua3/index.php/Admin/Industry/lists">行业资讯</a><span class="crumb-step">&gt;</span><span>新增资讯</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/shanghua3/index.php/Admin/Industry/doAdd" method="post" id="myform" name="myform" enctype="multipart/form-data">
