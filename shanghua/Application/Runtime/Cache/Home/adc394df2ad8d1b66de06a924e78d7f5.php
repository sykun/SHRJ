...
<body>
  <div id="nav-header">
    ...
    <div id="nav-right">
      <p><a href="/shanghua/index.php/Home/Job/detail1">中文&nbsp;</a>|<a href="/shanghua/index.php/Home/Job/detail1e">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
  ...
  <div id="bread">
    <div id="bread-left">PHP技术支持</div>
      <div id="bread-right"><a href="/shanghua/index.php/Home/Index/index">首页&nbsp;</a>>><a href="/shanghua/index.php/Home/Honor/jianjie">&nbsp;关于上华&nbsp;</a>>><a href="/shanghua/index.php/Home/Job/join1">&nbsp;加入我们&nbsp;</a>>>&nbsp;PHP技术支持</div>
  </div>
  ...
  <div>
      <div class="container">
          ...
          <div class="col-md-4">
            ...
            <hr style="border:none;border-top:2px ridge orange;width:40px;margin-top:5px;position:absolute;" /><br/>
             <div  class="ecobadding15">
                ...
                <ul class="p0 clouds">
                  ...
                  <li><a href="/shanghua/index.php/Home/Success/VE" title="金融"  target='_self'>VE</a></li>

                  <li><a href="/shanghua/index.php/Home/Success/gl" title="融资业务"  target='_self'>管廊</a></li>

                  <li><a href="/shanghua/index.php/Home/Product/gongyi" title="信用担保"  target='_self'>工艺设计软件</a></li>

                  <li><a href="/shanghua/index.php/Home/Product/lvse" title="典当服务"  target='_self'>绿色建筑</a></li>

                  <li><a href="/shanghua/index.php/Home/Product/zhushou" title="融资租赁"  target='_self'>设计助手</a></li>

                  <li><a href="/shanghua/index.php/Home/Product/fengli" title="理财咨询"  target='_self'>风管水力计算</a></li>
            ...
            <?php if(is_array($job)): $i = 0; $__LIST__ = array_slice($job,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h2 class="h1"><?php echo ($vo["title"]); ?></h2>
    ...
    <div class="panel-footer">
      ...
      <div class="met_tools">
        ...
        <ul class="met_page">
          ...
          <li class="met_page_preinfo"><span>上一条</span><a href='/shanghua/index.php/Home/Job/detail2'>网络销售</a></li>
