...
<body>
  ...
  <div id="bread">
    <div id="bread-left">产品服务</div>
      <div id="bread-right"><a href="<?php echo U('Index/index');?>">首页&nbsp;</a>>><a href="<?php echo U('Product/product');?>">&nbsp;产品服务&nbsp;</a>>>&nbsp;PDMS风管阻力计算</div>
  </div>
  
  <div class="product-content">
        <div class="product-v1">
          <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,23,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h2><?php echo ($vo["title"]); ?></h2><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
        <div class="product-v2">
            <div class="fl">
            <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,24,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul >
            ...
            <div class="fr">
                ...
                <h3>软件介绍</h3><br/>
                <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,25,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p><?php echo ($vo["content"]); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>  
            </div>
        </div>
        <div class="product-v3">
            <div class="fr">
                ...
                <h3>软件功能</h3><br/>
                <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,26,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p>
                   <?php echo ($vo["content"]); ?>
                </p><?php endforeach; endif; else: echo "" ;endif; ?> 
            </div>
            <div class="fl">
                <ul >
                  <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,27,6,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><?php echo ($vo["content"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>  
                </ul><br/><br/>
                <h3>软件特性</h3>
            </volist>            
            </div>
