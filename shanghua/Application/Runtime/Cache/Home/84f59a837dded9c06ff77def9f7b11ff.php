...
<body>
  ...
  <div id="bread">
    <div id="bread-left">产品服务</div>
      <div id="bread-right"><a href="<?php echo U('Index/index');?>">首页&nbsp;</a>>><a href="<?php echo U('Product/product');?>">&nbsp;产品服务&nbsp;</a>>>&nbsp;PDMS综合材料自动排版</div>
  </div>
  

  <div class="product-content">
    <div class="product-v1">
      <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,18,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h2><?php echo ($vo["title"]); ?></h2><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
    <div class="product-v2">
     <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,19,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="div-a">
    ...
    <div class="product-v3">
      ...
      <h3>总体介绍</h3><br/>
      <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,20,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p>&nbsp;&nbsp;&nbsp;&nbsp;
        <?php echo ($vo["content"]); ?>
      </p>
    ...
    <div class="product-v4">
      ...
      <h3>主界面截图</h3><br/>
      <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,21,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src='/shanghua/Public/<?php echo ($vo["thumb"]); ?>' width="47%"height="50%"><?php endforeach; endif; else: echo "" ;endif; ?>
      <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,22,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src='/shanghua/Public/<?php echo ($vo["thumb"]); ?>' width="47%"height="50%"style="padding-left:4%"><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
