...
<body>
    ...
    <div id="nav-right">
      <p><a href="<?php echo U('Industry/industry?p=1');?>">中文&nbsp;</a>|<a href="<?php echo U('Industry/industrye?p=1');?>">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
    <img src="/shanghua/Public/home/images/industry.jpg">
  </div>
  <div id="bread">
    <div id="bread-left">News</div>
      <div id="bread-right"><a href="<?php echo U('Index/indexe');?>">Home&nbsp;</a>>><a href="<?php echo U('New/companye?p=1');?>">&nbsp;News&nbsp;</a>>>&nbsp;Industry</div>
  </div>
	...
	<div id="new-company">
      ...
      <div id="new-company-new">
        ...
        <ul class="new">
          <li><a href="<?php echo U('New/companye?p=1');?>" ><em class='em2'></em>Company</a></li>
          <li><a href="<?php echo U('Industry/industrye?p=1');?>" class='active' style="color:#FFBB77"><em class="em1"></em>Industry</a></li>
        </ul>
      </div>
      <div id="new-company-product">
        ...
        <HR align="left" width="10%" color="#FFBB77" SIZE="3" style="margin-top:10px;">
        <ul>
          <li class="new-company-img1"><a href="<?php echo U('Product/zonghee');?>"><img src="/shanghua/Public/home/images/left1.jpg"></a>
            <p class="new-goods">PDMS</p>
            <p class="new-more"><a href="<?php echo U('Product/zonghee');?>" id="product1">MORE</a></p>
          </li>
          <li class="new-company-img2"><a href="<?php echo U('Product/lvsee');?>"><img src="/shanghua/Public/home/images/left2.jpg"></a>
            <p class="new-goods">Green Building</p>
            <p class="new-more"><a href="<?php echo U('Product/lvsee');?>" id="product2">MORE</a><p>
          </li>
          <li class="new-company-img3"><a href="<?php echo U('Product/intergradee');?>"><img src="/shanghua/Public/home/images/left3.png"></a>
            <p class="new-goods">Design</p>
            <p class="new-more"><a href="<?php echo U('Product/intergradee');?>" id="product3">MORE</a></p>
          </li>
        </ul>
      </div>
      <div id="new-company-hot">
		...
		<div id="new-company-right">
          ...
          <?php if(is_array($industryen)): $i = 0; $__LIST__ = $industryen;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><div class="box">
						<ul>
							<li>
								<a href="/shanghua/index.php/Home/Industry/contente/id/<?php echo ($d["id"]); ?>"><img src="/shanghua/Public/<?php echo ($d["thumb"]); ?>" alt="" /></a>
								<div class="dask">
								</div>
								<div>
									...
									<div class="new-company-article-title">
										<h4><a href="/shanghua/index.php/Home/Industry/contente/id/<?php echo ($d["id"]); ?>">
            ...
            <div class="new-company-btn">
                    ...
                    <a href="/shanghua/index.php/Home/Industry/contente/id/<?php echo ($d["id"]); ?>" id="more1">See more&nbsp;>></a>
                  </div>
