...
<body>
  <div id="nav-header">
    ...
    <div id="nav-right">
      <p><a href="/shanghua/index.php/Home/Job/detail4">中文&nbsp;</a>|<a href="/shanghua/index.php/Home/Job/detail4e">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
  ...
  <div id="bread">
    <div id="bread-left">Web前端开发人员</div>
      <div id="bread-right"><a href="/shanghua/index.php/Home/Index/index">首页&nbsp;</a>>><a href="/shanghua/index.php/Home/Honor/jianjie">&nbsp;关于上华&nbsp;</a>>><a href="/shanghua/index.php/Home/Job/join2">&nbsp;加入我们&nbsp;</a>>>&nbsp;Web前端开发人员</div>
  </div>
            ...
            <hr style="border:none;border-top:2px ridge orange;width:40px;margin-top:5px;position:absolute;" /><br/>
             <div  class="ecobadding15">
                <div class="single_product_item">
                  ...
                  <p>智慧管廊</p>
                    <a  href="/shanghua/index.php/Home/Product/gl" title="智慧管廊" target='_self'>MORE</a>
                </div>
                ...
                <ul class="p0 clouds">
                  ...
                  <li><a href="/shanghua/index.php/Home/Product/gl"  target='_self'>管廊</a></li>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body met_editor">
      <div><div><span style="font-size:14px;"><strong>主要工作内容：</strong></span>负责Shanghua企业网站管理系统前台模板功能设计、用户体验提升和Web界面技术优化。</div><div><span style="font-size:14px;"><strong>岗位要求：</strong></span></div><ol><li>熟悉JavaScript、Ajax、JQuery等前端开发脚本技能；</li><li>精通HTML/XHTML、CSS，能够快速手写CSS代码，熟悉页面架构和布局。</li><li>熟悉Web网站以及Web应用的可用性及用户分析方法，深入理解产品流程、用户体验和用户需求，对提升用户体验有一定经验及造诣。</li><li>对Web技术发展有强烈兴趣，有良好的学习能力和强烈的进取心，愿意同公司共同发展。</li><li>能跟踪最新的WEB前端设计、懂PHP基本语言者优先。</li></ol></div><div class="clearfix"></div>
    </div>
    ...
    <div class="panel-footer">
      ...
      <div class="met_tools">
        ...
        <ul class="met_page">
          ...
          <li class="met_page_preinfo"><span>上一条</span><a href='/shanghua/index.php/Home/Job/detail3'>电子商务专员</a></li>


          <li class="met_page_next"><span>下一条</span><a href='/shanghua/index.php/Home/Job/detail5'>网页UI设计师</a></li>
