...
<body>
  <div id="nav-header">
    ...
    <div id="nav-right">
      <p><a href="/shanghua/index.php/Home/Job/detail2">中文&nbsp;</a>|<a href="/shanghua/index.php/Home/Job/detail2e">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
  ...
  <div id="bread">
    <div id="bread-left">网络销售</div>
      <div id="bread-right"><a href="/shanghua/index.php/Home/Index/index">首页&nbsp;</a>>><a href="/shanghua/index.php/Home/Honor/jianjie">&nbsp;关于上华&nbsp;</a>>><a href="/shanghua/index.php/Home/Job/join1">&nbsp;加入我们&nbsp;</a>>>&nbsp;网络销售</div>
  </div>
          ...
          <div class="col-md-4">
            ...
            <hr style="border:none;border-top:2px ridge orange;width:40px;margin-top:5px;position:absolute;" /><br/>
              <ul class="p0 category_item met_aside_list ecopc">
                ...
                <li><a href="/shanghua/index.php/Home/job/join1" class='active'  title="加入我们" target='_self'><i class="fa fa-angle-right"></i><em class="em1"></em>&nbsp;&nbsp;加入我们</a> 
            ...
            <hr style="border:none;border-top:2px ridge orange;width:40px;margin-top:5px;position:absolute;" /><br/>
             <div  class="ecobadding15">
                <div class="single_product_item">
                  <a  href="/shanghua/index.php/Home/Success/gl" title="智慧管廊" target='_self'><img src="/shanghua/Public/home/images/4.jpg" alt="智慧管廊" title="智慧管廊"></a> 
                  <p>智慧管廊</p>
                    <a  href="/shanghua/index.php/Home/Success/gl" title="智慧管廊" target='_self'>MORE</a>
                </div>
                

                
                <div class="single_product_item">
                  <a  href="/shanghua/index.php/Home/Product/lvs" title="VE" target='_self'><img src="/shanghua/Public/home/images/5.png" alt="VE" title="VE"></a> 
                  <p>绿色建筑</p>
                    <a  href="/shanghua/index.php/Home/Product/lvs" title="VE" target='_self'>MORE</a>
                </div>
            ...
            <?php if(is_array($job)): $i = 0; $__LIST__ = array_slice($job,1,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix resshowjob">
  <h2 class="h1"><?php echo ($vo["title"]); ?></h2>

  <div class="panel panel-default">

    <ul class="list-group">
      <li class="list-group-item">招聘人数：<?php echo ($vo["num"]); ?></li>
      <li class="list-group-item">工作地点：<?php echo ($vo["place"]); ?></li>
      <li class="list-group-item">工资待遇：<?php echo ($vo["afford"]); ?></li>
      <li class="list-group-item">发布日期：<?php echo ($vo["time"]); ?></li>
      <li class="list-group-item">有效期：<?php echo ($vo["deadline"]); ?> </li>
    ...
    <div class="panel-footer">
      ...
      <div class="met_tools">
        ...
        <ul class="met_page">
          ...
          <li class="met_page_preinfo"><span>上一条</span><a href='/shanghua/index.php/Home/Job/detail3'>网页UI设计师</a></li>


          <li class="met_page_next"><span>下一条</span><a href='/shanghua/index.php/Home/Job/detail1'>PHP技术支持</a></li>
