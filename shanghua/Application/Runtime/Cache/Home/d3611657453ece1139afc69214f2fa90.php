...
<body>
  ...
  <div id="nav-header">
    ...
    <div id="nav-right">
       <p><a href="<?php echo U('Job/join?p=1');?>">中文&nbsp;</a>|<a href="<?php echo U('Job/joine?p=1');?>">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
    <img src="/shanghua/Public/home/images/join.jpg">
  </div>
  <div id="bread">
    <div id="bread-left">加入我们</div>
      <div id="bread-right"><a href="<?php echo U('Index/index');?>">首页&nbsp;</a>>><a href="<?php echo U('Honor/jianjie');?>">&nbsp;关于上华&nbsp;</a>>>&nbsp;加入我们</div>
  </div>
          ...
          <div class="col-md-4">
            ...
            <hr style="border:none;border-top:2px ridge orange;width:40px;margin-top:5px;position:absolute;" /><br/>
             <div  class="ecobadding15">
                ...
                <div class="single_product_item">
                  <a  href="<?php echo U('Product/lvse');?>"  target='_self'><img src="/shanghua/Public/home/images/5.png" alt="VE"></a> 
                  <p>绿色建筑</p>
                    <a  href="<?php echo U('Product/lvse');?>"  target='_self'>MORE</a>
                </div>               
                <div class="single_product_item">
...
<?php if(is_array($job)): $i = 0; $__LIST__ = $job;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="panel panel-default">
   <div class="panel-heading">
      <a href='/shanghua/index.php/Home/Job/content/id/<?php echo ($vo["id"]); ?>' title='<?php echo ($vo["title"]); ?>' target='_self'><strong><?php echo ($vo["title"]); ?></strong></a>
  ...
  <div class="list-group">
   ...
   <div class="panel-footer">
    <ul class="list-inline">
      <li><a href='/shanghua/index.php/Home/Job/content/id/<?php echo ($vo["id"]); ?>' class="btn-primary" title='查看详细' target='_self'>查看详细</a></li> 
    </ul>
