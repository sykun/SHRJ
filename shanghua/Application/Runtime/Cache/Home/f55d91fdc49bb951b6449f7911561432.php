...
<body>
  <div id="nav-header">
    ...
    <div id="nav-right">
      <p><a href="<?php echo U('Product/product');?>">中文&nbsp;</a>|<a href="<?php echo U('Product/producte');?>">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
    <img src="/shanghua/Public/home/images/product9.jpg">
  </div>
  <div id="bread">
    <div id="bread-left">Products</div>
      <div id="bread-right"><a href="<?php echo U('Index/indexe');?>">Home&nbsp;</a>>><span style="color:#3c3c3c">&nbsp;Products&nbsp;</span></div>
  </div>
  
  <div class="pro-content">
  <?php if(is_array($producten)): $i = 0; $__LIST__ = array_slice($producten,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="box"> 
     <div class="he_border1"> 
          <img class="he_border1_img" src='/shanghua/Public/<?php echo ($vo["thumb"]); ?>' alt="Image 01"> 
          <div class="he_border1_caption"> 
              <h3 class="he_border1_caption_h"><?php echo ($vo["title"]); ?></h3>
              <p class="he_border1_caption_p"><?php echo ($vo["content"]); ?></p>
              <a class="he_border1_caption_a" href="<?php echo U('Product/intergradee');?>" target="_blank"></a>
          </div> 
      </div> 
    </div><?php endforeach; endif; else: echo "" ;endif; ?>
  <?php if(is_array($producten)): $i = 0; $__LIST__ = array_slice($producten,1,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="box"> 
     <div class="he_border1"> 
          <img class="he_border1_img" src='/shanghua/Public/<?php echo ($vo["thumb"]); ?>' alt="Image 01"> 
          <div class="he_border1_caption"> 
              <h3 class="he_border1_caption_h"><?php echo ($vo["title"]); ?></h3>
              <p class="he_border1_caption_p"><?php echo ($vo["content"]); ?></p>
              <a class="he_border1_caption_a" href="<?php echo U('Product/operatione');?>" target="_blank"></a>
          </div> 
      </div> 
    </div><?php endforeach; endif; else: echo "" ;endif; ?>
  <?php if(is_array($producten)): $i = 0; $__LIST__ = array_slice($producten,2,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="box"> 
     <div class="he_border1"> 
          <img class="he_border1_img" src='/shanghua/Public/<?php echo ($vo["thumb"]); ?>' alt="Image 01"> 
          <div class="he_border1_caption"> 
              <h3 class="he_border1_caption_h"><?php echo ($vo["title"]); ?></h3>
              <p class="he_border1_caption_p"><?php echo ($vo["content"]); ?></p>
              <a class="he_border1_caption_a" href="<?php echo U('Product/lvsee');?>" target="_blank"></a>
          </div> 
      </div> 
    </div><?php endforeach; endif; else: echo "" ;endif; ?>
  <?php if(is_array($producten)): $i = 0; $__LIST__ = array_slice($producten,3,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="box"> 
     <div class="he_border1"> 
          <img class="he_border1_img" src='/shanghua/Public/<?php echo ($vo["thumb"]); ?>' alt="Image 01"> 
          <div class="he_border1_caption"> 
              <h3 class="he_border1_caption_h"><?php echo ($vo["title"]); ?></h3>
              <p class="he_border1_caption_p"><?php echo ($vo["content"]); ?></p>
              <a class="he_border1_caption_a" href="<?php echo U('Product/zhushoue');?>" target="_blank"></a>
          </div> 
      </div> 
    </div><?php endforeach; endif; else: echo "" ;endif; ?>
  <?php if(is_array($producten)): $i = 0; $__LIST__ = array_slice($producten,4,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="box"> 
     <div class="he_border1"> 
          <img class="he_border1_img" src='/shanghua/Public/<?php echo ($vo["thumb"]); ?>' alt="Image 01"> 
          <div class="he_border1_caption"> 
              <h3 class="he_border1_caption_h"><?php echo ($vo["title"]); ?></h3>
              <p class="he_border1_caption_p"><?php echo ($vo["content"]); ?></p>
              <a class="he_border1_caption_a" href="<?php echo U('Product/zonghee');?>" target="_blank"></a>
          </div> 
      </div> 
    </div><?php endforeach; endif; else: echo "" ;endif; ?>
  <?php if(is_array($producten)): $i = 0; $__LIST__ = array_slice($producten,5,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="box"> 
     <div class="he_border1"> 
          <img class="he_border1_img" src='/shanghua/Public/<?php echo ($vo["thumb"]); ?>' alt="Image 01"> 
          <div class="he_border1_caption"> 
              <h3 class="he_border1_caption_h"><?php echo ($vo["title"]); ?></h3>
              <p class="he_border1_caption_p"><?php echo ($vo["content"]); ?></p>
              <a class="he_border1_caption_a" href="<?php echo U('Product/fenglie');?>" target="_blank"></a>
          </div> 
      </div> 
    </div><?php endforeach; endif; else: echo "" ;endif; ?>
  <?php if(is_array($producten)): $i = 0; $__LIST__ = array_slice($producten,6,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="box"> 
     <div class="he_border1"> 
          <img class="he_border1_img" src='/shanghua/Public/<?php echo ($vo["thumb"]); ?>' alt="Image 01"> 
          <div class="he_border1_caption"> 
              <h3 class="he_border1_caption_h"><?php echo ($vo["title"]); ?></h3>
              <p class="he_border1_caption_p"><?php echo ($vo["content"]); ?></p>
              <a class="he_border1_caption_a" href="<?php echo U('Product/gongyie');?>" target="_blank"></a>
          </div> 
      </div> 
    </div><?php endforeach; endif; else: echo "" ;endif; ?>
  </div>
  ...
  <div id="footer1">
    ...
    <div id="footer-bottom">
      <div id="footer-bottom1"><p>My website copyright all 2008-2014 Xiang 8888888<br/> for ICP This page content for the website demonstration data, front page content can be modified in the background.<br/>
