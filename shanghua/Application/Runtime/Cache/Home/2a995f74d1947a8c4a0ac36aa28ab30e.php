...
<head>
  ...
  <link href="/shanghua/Public/home/css/nav.css" type="text/css" rel="stylesheet" />
   <link rel="stylesheet" href="/shanghua/Public/home/css/gongyi.css" />
...
<body>
  ...
  <div id="nav-header">
    ...
    <div id="nav-right">
     <p><a href="<?php echo U('Product/gongyi');?>">中文&nbsp;</a>|<a href="<?php echo U('Product/gongyie');?>">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
    <img src="/shanghua/Public/home/images/gongyi.jpg">
  </div>
  <div id="bread">
    <div id="bread-left">Products</div>
      <div id="bread-right"><a href="<?php echo U('Index/indexe');?>">Home&nbsp;</a>>><a href="<?php echo U('Product/producte');?>">&nbsp;Products&nbsp;</a>>>&nbsp;Process</div>
  </div>
  

  <div class="product-content">
            <div class="product-v1" style="text-align: center;" >
                 <?php if(is_array($producten)): $i = 0; $__LIST__ = array_slice($producten,33,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h2><?php echo ($vo["title"]); ?></h2><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
            <div class="product-v2 clearfix">
            <?php if(is_array($producten)): $i = 0; $__LIST__ = array_slice($producten,34,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="fl">
                 <img src='/shanghua/Public/<?php echo ($vo["thumb"]); ?>' width="80%"/>
                </div>
                <div class="fr">
                  <div class="extP_div">
                  
                  <h3><?php echo ($vo["title"]); ?></h3><br/>
                  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vo["content"]); ?></p>
                  </div>
                </div><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
            <div class="product-v3 " >
            <?php if(is_array($producten)): $i = 0; $__LIST__ = array_slice($producten,36,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="fl"style="padding-top:80px" >
                    <h3><?php echo ($vo["title"]); ?></h3><br/>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vo["content"]); ?></p>
                   
                </div>
                <div class="fr" style="float:left">
                   <img src='/shanghua/Public/<?php echo ($vo["thumb"]); ?>' />
                </div><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>  
        </div>
