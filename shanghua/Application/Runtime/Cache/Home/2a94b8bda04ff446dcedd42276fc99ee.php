...
<link href="/hotel/Public/home/templates/jd_1/style.css" type="text/css" rel="stylesheet" />
...
<div class="top_box">
 <div class="top_box_inner">
   ...
   <div class="logo"><a href=""><img src="/hotel/Public/home/images/logo.jpg" border="0"></a></div>
...
<li class="menu_style" id="MenuItem62" name="MenuItem"><a href="about/" class="menu">酒店简介</a></li>
<li class="menu_style" id="MenuItem64" name="MenuItem"><a href="jdkf/" class="menu">酒店客房</a></li>
<li class="menu_style" id="MenuItem63" name="MenuItem"><a href="news/" class="menu">酒店新闻</a></li>
<li class="menu_style" id="MenuItem77" name="MenuItem"><a href="swhy/" class="menu">商务会议</a></li>
<li class="menu_style" id="MenuItem68" name="MenuItem"><a href="rczp/" class="menu">人力资源</a></li>
...
<tr>
<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td align=center style="padding:2px" >
<a href="#" target="_self"><img src="/hotel/Public/<?php echo ($vo["thumb"]); ?>" border="0" style="width:150px;height:105px;"></a>
<br>
<a href="#" target="_self" title="<?php echo ($vo["catname"]); ?>"><?php echo ($vo["catname"]); ?></a>
...
<img border="0" alt="" vspace="5" width="192" height="126" src="/hotel/Public/home/upload/s1/fck/image/2012-11/17133202.jpg" />
</div></div>

  </div>
 </div>
 <div class="clear main_box_inner_bottom"></div>
</div><div class="bottom_box"><p>
	<a href="#" onClick="setHome(this,'http://www.genban.org')">设为首页</a> | <a href="javascript:AddFavorite(location.href,'网站名称')">加入收藏</a> | <a href="#">留言反馈</a>&nbsp;|&nbsp;<a href="#">人才招聘</a>&nbsp;| <a href="#">联系我们</a>&nbsp;<br />
...
</script></div><div align='center' style='padding:5px'>Powered by <a href='http://www.genban.org' target='_blank'><strong>酒店管理公司网站模板</strong></a></div></div></body></html>