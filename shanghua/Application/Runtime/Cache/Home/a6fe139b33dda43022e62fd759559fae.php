...
<head>
  ...
  <script type="text/javascript" src="/shanghua/Public/home/js/modernizr.custom.js"></script>
   <link rel="stylesheet" href="/shanghua/Public/home/css/bootstrap.min.css">
   <!--  -->
...
<div id="bread">
    <div id="bread-left">成功案例</div>
      <div id="bread-right"><a href="<?php echo U('Index/index');?>">首页&nbsp;</a>>><a href="<?php echo U('Success/gl');?>">&nbsp;成功案例&nbsp;</a>>>&nbsp;VE</div>
  </div>

   <div class="content">
    <p>&nbsp;&nbsp;&nbsp;&nbsp;北京上华软件有限公司是一家服务于勘察设计信息化发展领域的新型高科技信息化公司。其团队核心工程师拥有本行业十余年的资历，曾经开发过在市面上具备垄断水平的多款软件产品。如今，他们，致力于最新型的技术模式引领行业信息化作为其发展目标.</p>
    <h3>成功案例展示</h3>
  </div>
<div id="latest-news-container" class="latest-news-container">
<div class="single-wrapper">
<?php if(is_array($case)): $i = 0; $__LIST__ = array_slice($case,6,9,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="single-item single-item-1">
