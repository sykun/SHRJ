...
<body>
  ...
  <div id="bread">
    <div id="bread-left">Contact</div>
      <div id="bread-right"><a href="<?php echo U('Index/indexe');?>">Home&nbsp;>></a>&nbsp;Contact</div>
  </div>
  <div id="new-company">
    <div id="new-company-left">
      <div id="new-company-new">
        ...
        <ul class="new">
          <li><a href="<?php echo U('Contact/contacte');?>" class='active' style="color:#FFBB77"><em class='em1'></em>Contact</a></li>
        </ul>
      </div>
      ...
      <h3 style="margin-left:30px;">Contact</h3>
      <HR align="left" width="5%" color="#FFBB77" SIZE="3" style="margin-top:10px;margin-left:30px;">
        <div class="contact1">
          <h5>Telephone：400-700-3609</h5>
          
        </div>
        <div class="contact1">
          <h5>BusinessQQ：328007406</h5>
        </div>
        <div class="contact1">
          <h5>Address：www.shanghua.com</h5>
        </div>
        <div class="contact1">
          <h5>Fax：400-700-3609</h5>
        </div>
        <div class="contact1" >
        <h5 style="padding-left:20px;padding-right:20px;">Address: Beijing City, Fengtai District Jianhua Street Shanghua Software Co. Ltd.</h5>
        </div>
        <div class="contact1" >
        <h5 style="padding-left:20px;padding-right:20px;">24 hour Hotline：15289016539</h5>
        </div>
    </div>
    </div>
    </div>
