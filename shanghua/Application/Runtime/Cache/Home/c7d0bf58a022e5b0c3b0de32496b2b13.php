...
<body>
 ...
 <div id="nav-header">
    ...
    <div id="nav-right">
      <p><a href="<?php echo U('Product/zhushou');?>">中文&nbsp;</a>|<a href="<?php echo U('Product/zhushou');?>">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
  ...
  <div id="bread">
    <div id="bread-left">产品服务</div>
      <div id="bread-right"><a href="<?php echo U('Index/index');?>">首页&nbsp;</a>>><a href="<?php echo U('Product/product');?>">&nbsp;产品服务&nbsp;</a>>>&nbsp;设计助手DWHelp</div>
  </div>
  
<div class="product-content">
    <div class="product-v1">
      <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,14,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h2><?php echo ($vo["title"]); ?></h2><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
    ...
    <div class="product-v2">
      ...
      <h3>总体介绍</h3><br/>
      <p>
      <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,15,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vo["content"]); endforeach; endif; else: echo "" ;endif; ?>
      </p>
    </div>
    <div class="product-v3">
      <h2>SOFTWARE MAIN INTERFACE</h2>
      <h3>软件主界面</h3><br/>
      <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,16,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p><?php echo ($vo["content"]); ?><p class="tu">(单击图片可查看原图)</p></p><br/>         
    ...
    <div class="product-v4">
      ...
      <h3>软件功能特点</h3><br/>
      <?php if(is_array($product)): $i = 0; $__LIST__ = array_slice($product,17,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p>
        <?php echo ($vo["content"]); ?>
