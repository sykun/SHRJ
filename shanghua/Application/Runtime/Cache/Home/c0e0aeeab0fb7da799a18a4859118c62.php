...
<body>
  ...
  <div id="bread">
    <div id="bread-left">Company Honor</div>
      <div id="bread-right"><a href="<?php echo U('Index/indexe');?>">Home&nbsp;</a>>><a href="<?php echo U('Honor/jianjiee');?>">&nbsp;About Shanghua&nbsp;</a>>>&nbsp;Company Honor</div>
  </div>
     <div>
      <div class="container">
          ...
          <div class="col-md-4">
            ...
            <hr style="border:none;border-top:2px ridge orange;width:40px;margin-top:5px;position:absolute;" /><br/>
              <ul class="p0 category_item met_aside_list ecopc">
                ...
                <li><a href="<?php echo U('Honor/rongyue');?>" class='active'  title="公司荣誉" target='_self'><i class="fa fa-angle-right"></i><em class="em1"></em>&nbsp;&nbsp;Company Honor</a> 
          ...
          <div class="col-md-7 shop-page-content">
            ...
            <div class="section-title-style-2">
             ...
             <?php if(is_array($honoren)): $i = 0; $__LIST__ = $honoren;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="img2">
            <ul>
