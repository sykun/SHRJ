...
<body>
  ...
  <div id="nav-header">
    ...
    <div id="nav-right">
       <p><a href="/shanghua/index.php/Home/Job/join1">中文&nbsp;</a>|<a href="/shanghua/index.php/Home/Job/join1e">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
          ...
          <div class="col-md-4">
            ...
            <hr style="border:none;border-top:2px ridge orange;width:40px;margin-top:5px;position:absolute;" /><br/>
             <div  class="ecobadding15">
                ...
                <div class="single_product_item">
                  <a  href="/shanghua/index.php/Home/Product/lvse"  target='_self'><img src="/shanghua/Public/home/images/5.png" alt="VE"></a> 
                  <p>绿色建筑</p>
                    <a  href="/shanghua/index.php/Home/Product/lvse"  target='_self'>MORE</a>
                </div>               
                <div class="single_product_item">
                ...
                <ul class="p0 clouds">
                  ...
                  <li><a href="/shanghua/index.php/Home/Product/intergrade"   target='_self'>智慧管廊</a></li>
...
<?php if(is_array($job)): $i = 0; $__LIST__ = array_slice($job,0,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="panel panel-default">
  ...
  <div class="list-group">
   ...
   <div class="panel-footer">
    <ul class="list-inline">
      <li><a href='/shanghua/index.php/Home/Job/detail<?php echo ($vo["id"]); ?>' class="btn-primary" title='查看详细' target='_self'>查看详细</a></li> 
    </ul>
     ...
     <div id="flip">
        <div class='met_pager'>
      <span class='PreSpan'>上一页</span><a href="#" class='Ahover'>1</a><a href="/shanghua/index.php/Home/Job/join2" >2</a><a href="/shanghua/index.php/Home/Job/join2" class='NextA'>下一页</a>
        </div>
    </div>
