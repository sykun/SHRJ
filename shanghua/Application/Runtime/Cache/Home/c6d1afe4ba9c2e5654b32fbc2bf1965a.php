...
<body>
  <div id="nav-header">
    ...
    <div id="nav-right">
       <p><a href="/shanghua/index.php/Home/Job/join2">中文&nbsp;</a>|<a href="/shanghua/index.php/Home/Job/join2e">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
  ...
  <div id="bread">
    <div id="bread-left">加入我们</div>
      <div id="bread-right"><a href="/shanghua/index.php/Home/Index/index">首页&nbsp;</a>>><a href="/shanghua/index.php/Home/Honor/jianjie">&nbsp;关于上华&nbsp;</a>>>&nbsp;加入我们</div>
  </div>
          ...
          <div class="col-md-4">
            ...
            <hr style="border:none;border-top:2px ridge orange;width:40px;margin-top:5px;position:absolute;" /><br/>
              <ul class="p0 category_item met_aside_list ecopc">
                ...
                <li><a href="/shanghua/index.php/Home/Honor/jianjie" title="公司简介" target='_self'><i class="fa fa-angle-right"></i><em class="em2"></em>&nbsp;&nbsp;公司简介</a> 
             
                </li>

                <li><a href="/shanghua/index.php/Home/Honor/wenhua"  title="公司文化" target='_self'><i class="fa fa-angle-right"></i><em class="em2"></em>&nbsp;&nbsp;公司文化</a> 
             
                </li>

                <li><a href="/shanghua/index.php/Home/Honor/rongyu"  title="公司荣誉" target='_self'><i class="fa fa-angle-right"></i><em class="em2"></em>&nbsp;&nbsp;公司荣誉</a> 
             
                </li>

                <li><a href="/shanghua/index.php/Home/Job/join2" class='active'  title="加入我们" target='_self'><i class="fa fa-angle-right"></i><em class="em1"></em>&nbsp;&nbsp;加入我们</a> 
            ...
            <hr style="border:none;border-top:2px ridge orange;width:40px;margin-top:5px;position:absolute;" /><br/>
             <div  class="ecobadding15">
                <div class="single_product_item">
                  <a  href="/shanghua/index.php/Home/Product/gl" title="智慧管廊" target='_self'><img src="/shanghua/Public/home/images/4.jpg" alt="智慧管廊" title="智慧管廊"></a> 
                  <p>智慧管廊</p>
                    <a  href="gl-cn" title="智慧管廊" target='_self'>MORE</a>
                </div>
                

                
                <div class="single_product_item">
                  <a  href="/shanghua/index.php/Home/Product/lvse" title="VE" target='_self'><img src="/shanghua/Public/home/images/5.png" alt="VE" title="VE"></a> 
                  <p>绿色建筑</p>
                    <a  href="/shanghua/index.php/Home/Product/lvse" title="VE" target='_self'>MORE</a>
                </div>
                

                
                <div class="single_product_item">
                  <a  href="/shanghua/index.php/Home/Product/gongyi" title="工艺设计软件" target='_self'><img src="/shanghua/Public/home/images/7.png" alt="工艺设计软件" title="工艺设计软件"></a> 
                  <p>设计软件</p>
                    <a  href="/shanghua/index.php/Home/Product/gongyi" title="工艺设计软件" target='_self'>MORE</a>
                </div>
                </div>
                <br/><br/><br/>
                <div>
                ...
                <ul class="p0 clouds">
                  ...
                  <li><a href="/shanghua/index.php/Home/Success/VE"  target='_self'>VE</a></li>

                  <li><a href="/shanghua/index.php/Home/Product/intergrade"  target='_self'>管廊</a></li>

                  <li><a href="/shanghua/index.php/Home/Product/gongyi"  target='_self'>工艺设计软件</a></li>

                  <li><a href="/shanghua/index.php/Home/Product/lvse"  target='_self'>绿色建筑</a></li>

                  <li><a href="/shanghua/index.php/Home/Product/zhushou" target='_self'>设计助手</a></li>

                  <li><a href="/shanghua/index.php/Home/Product/fengli" target='_self'>风管水力计算</a></li>
...
<?php if(is_array($job)): $i = 0; $__LIST__ = array_slice($job,3,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="panel panel-default">
   <div class="panel-heading">
      <a href='/shanghua/index.php/Home/Job/detail<?php echo ($vo["id"]); ?>' title='<?php echo ($vo["title"]); ?>' target='_self'><strong><?php echo ($vo["title"]); ?></strong></a>
  ...
  <div class="list-group">
      ...
      <ul class="list-inline">
        <li>发布日期：<?php echo ($vo["time"]); ?></li>
        <li>工作地点：<?php echo ($vo["place"]); ?></li>
        <li>招聘人数：<?php echo ($vo["num"]); ?></li>
      </ul>
        </span>
    </div>
   <div class="panel-body met_editor">
      <span style="font-size:16px;"><strong>主要工作内容：</strong></span><div><?php echo ($vo["content"]); ?></div><div>&nbsp;</div><div><span style="font-size:16px;"><strong>岗位要求：</strong></span></div><ol><?php echo ($vo["demand"]); ?></ol>
   </div>
   <div class="panel-footer">
    <ul class="list-inline">
      <li><a href='/shanghua/index.php/Home/Job/detail<?php echo ($vo["id"]); ?>' class="btn btn-primary" title='查看详细' target='_self'>查看详细</a></li>
    </ul>
...
<div class="panel panel-default">
   <div class="panel-heading">
      <a href='/shanghua/index.php/Home/Job/detail5' title='电子商务专员' target='_self'><strong>电子商务专员</strong></a>
  ...
  <div class="list-group">
   ...
   <div class="panel-body met_editor">
      <div><span style="font-size:14px;"><strong>主要工作内容：</strong></span>负责Shanghua企业网站管理系统在线销售工作，向客户提供迅速、准确、周到的服务。</div><div><span style="font-size:14px;"><strong>岗位要求：</strong></span></div><ol><li>熟悉互联网销售与推广；</li><li>能熟练操作网站管理系统后台，了解基本的建站知识；</li><li>能敏锐把握网站建设行业市场动向，善于把握客户心理；</li><li>沟通能力强，勤奋耐劳，办事认真严谨细致；</li><li>具有较强的学习能力，愿意同公司共同发展；</li><li>有网站建设相关产品工作经验者优先，电子商务、市场营销等相关专业优先。</li></ol>
   </div>
   <div class="panel-footer">
    <ul class="list-inline">
      <li><a href='/shanghua/index.php/Home/Job/detail5' class="btn btn-primary" title='查看详细' target='_self'>查看详细</a></li>
    </ul>
...
-->
      ...
      <div id="flip">
        <div class='met_pager'>
      <a href="/shanghua/index.php/Home/Job/join1" class='PreA'>上一页</a><a href="/shanghua/index.php/Home/Job/join1" >1</a><a href="#" class='Ahover'>2</a><span class='NextSpan'>下一页</span>
        </div>
    </div>
