...
<head>
  ...
  <link href="/shanghua/Public/home/css/proo.css" type="text/css" rel="stylesheet" />
...
<body>
  <div id="nav-header">
    ...
    <div id="nav-right">
      <p><a href="/shanghua/index.php/Home/Product/product">中文&nbsp;</a>|<a href="/shanghua/index.php/Home/Product/producte">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
    <img src="/shanghua/Public/home/images/pr1.png">
  </div>
  <div id="bread">
    <div id="bread-left">产品服务</div>
      <div id="bread-right"><a href="/shanghua/index.php/Home/Index/index">首页&nbsp;</a>>><span style="color:#3c3c3c">&nbsp;产品服务&nbsp;</span></a></div>
  </div>

<div class="pro-content">
  <div class="box"> 
   <div class="he_border1"> 
        <img class="he_border1_img" src="/shanghua/Public/home/images/pp1.png" alt="Image 01"> 
        <div class="he_border1_caption"> 
            <h3 class="he_border1_caption_h">设计软件</h3> 
            <p class="he_border1_caption_p">信息技术展示地下空间<br/>管廊性能分析</p> 
            <a class="he_border1_caption_a" href="/shanghua/index.php/Home/Product/intergrade" target="_blank"></a>
        </div> 
    </div> 
  </div>
  <div class="box"> 
   <div class="he_border1"> 
        <img class="he_border1_img" src="/shanghua/Public/home/images/pp6.png" alt="Image 01"> 
        <div class="he_border1_caption"> 
            <h3 class="he_border1_caption_h">运维系统</h3> 
            <p class="he_border1_caption_p">立足于工程建设信息化领域<br/>推进管廊建设</p> 
            <a class="he_border1_caption_a" href="/shanghua/index.php/Home/Product/operation" target="_blank"></a>
        </div> 
    </div> 
  </div> 
  <div class="box"> 
   <div class="he_border1"> 
        <img class="he_border1_img" src="/shanghua/Public/home/images/pp3.png" alt="Image 01"> 
        <div class="he_border1_caption"> 
            <h3 class="he_border1_caption_h">绿色建筑</h3> 
            <p class="he_border1_caption_p">集成化建筑性能模拟分析<br/>设计和分析的高度统一</p> 
            <a class="he_border1_caption_a" href="/shanghua/index.php/Home/Product/lvse" target="_blank"></a>
        </div> 
    </div> 
  </div>
  <div class="box"> 
   <div class="he_border1"> 
        <img class="he_border1_img" src="/shanghua/Public/home/images/pp4.png" alt="Image 01"> 
        <div class="he_border1_caption"> 
            <h3 class="he_border1_caption_h">设计助手DWHelp</h3> 
            <p class="he_border1_caption_p">立足ACE行业设计者角度<br/>提高设计效率</p> 
            <a class="he_border1_caption_a" href="/shanghua/index.php/Home/Product/zhushou" target="_blank"></a>
        </div> 
    </div> 
  </div>  
  <div class="box"> 
   <div class="he_border1"> 
        <img class="he_border1_img" src="/shanghua/Public/home/images/pp5.png" alt="Image 01"> 
        <div class="he_border1_caption"> 
            <h3 class="he_border1_caption_h">PDMS综合</h3> 
            <p class="he_border1_caption_p">基于利用EXCEL附属的VBA语言<br/>专注于三维管道设计
</p> 
            <a class="he_border1_caption_a" href="/shanghua/index.php/Home/Product/zonghe" target="_blank"></a>
        </div> 
    </div> 
  </div>  
  <div class="box"> 
   <div class="he_border1"> 
        <img class="he_border1_img" src="/shanghua/Public/home/images/pp2.png" alt="Image 01"> 
        <div class="he_border1_caption"> 
            <h3 class="he_border1_caption_h">PDMS风力</h3> 
            <p class="he_border1_caption_p">基于BIM离线导航平台开发<br/>符合国内设计规范的计算功能</p> 
            <a class="he_border1_caption_a" href="/shanghua/index.php/Home/Product/fengli" target="_blank"></a>
        </div> 
    </div> 
  </div>  
  <div class="box"> 
   <div class="he_border1"> 
        <img class="he_border1_img" src="/shanghua/Public/home/images/pp7.png" alt="Image 01"> 
        <div class="he_border1_caption"> 
            <h3 class="he_border1_caption_h">工艺设计软件</h3> 
            <p class="he_border1_caption_p">为你提供全方面的<br/>流程设计工具</p> 
            <a class="he_border1_caption_a" href="/shanghua/index.php/Home/Product/gongyi" target="_blank"></a>
        </div> 
    </div> 
  </div>    
  </div>
  <div id="footer" >
    ...
    <div id="footer-top2">
        <ul>
          ...
          <hr class="footer-hr">
          <li><a href="#">中国市政工程行业协会</a></li>
          <li><a href="#">中国勘察设计</a></li>
          <li><a href="#">上海规划局</a></li>
          <li><a href="#">中国BIM门户</a></li>
          <li><a href="#">中国市政工程行业协会</a></li>
        </ul>
    </div>
    ...
    <div id="footer-bottom">
      <div id="footer-bottom1"><p>我的网站 版权所有 2008-2014 湘ICP备8888888<br/>
     本页面内容为网站演示数据，前台页面内容都可以在后台修改。<br/>
      Powered by MetInfo</p></div>
    </div>
    </div>
    <div id="top"></div>
  </body>
