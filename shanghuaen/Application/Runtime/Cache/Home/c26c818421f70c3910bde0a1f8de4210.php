...
<body>
        ...
        <ul>
            <li><a href="<?php echo U('Honor/jianjie');?>">关于上华</a>
              <ul>
                ...
                <li><a href="<?php echo U('Honor/join1');?>">加入我们</a></li>
              </ul>
            </li>
        </ul>
    </div>
  ...
  <div id="bread">
    <div id="bread-left">新闻中心</div>
      <div id="bread-right"><a href="<?php echo U('Index/index');?>">首页&nbsp;</a>>><a href="<?php echo U('New/company?p=1');?>">&nbsp;新闻中心&nbsp;</a>>>&nbsp;行业资讯</div>
  </div>
	...
	<div id="new-company">
		<div id="new-company-left">
			<div id="new-company-new">
				...
				<ul class="new">
					<li><a href="<?php echo U('New/company?p=1');?>"  ><em class='em2'></em>公司新闻</a></li>
					<li><a href="<?php echo U('Industry/industry?p=1');?>" class='active' style="color:#FFBB77"><em class="em1"></em>行业动态</a></li>
				</ul>
			</div>
      ...
      <div id="new-company-hot">
         ...
         <HR align="left" width="10%" color="#FFBB77" SIZE="3" style="margin-top:10px;">
          <ul class="p0 clouds">
              ...
              <li><a href="<?php echo U('Success/gongyi');?>" target='_self'>工艺设计软件</a></li>
              <li><a href="<?php echo U('Success/lvse');?>" target='_self'>绿色建筑</a></li>
              <li><a href="<?php echo U('Success/zhushou');?>" target='_self'>设计助手</a></li>
              <li><a href="<?php echo U('Success/fengli');?>" target='_self'>风管水力计算</a></li>
          </ul>
      </div>
		</div>
      ...
      <HR align="left" width="5%" color="#FFBB77" SIZE="3" style="margin-top:10px;">
        <div id="new-company-content">
          ...
          <?php if(is_array($industry)): $i = 0; $__LIST__ = $industry;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><div class="box">
            <ul>
              <li>
                <a href="/shanghua/index.php/Home/Industry/content/id/<?php echo ($d["id"]); ?>"><img src="/shanghua/Public/<?php echo ($d["thumb"]); ?>" alt="" /></a>
                <div class="dask">
                </div>
                <div>
                  ...
                  <div class="new-company-article-title">
                    <h4><a href="/shanghua/index.php/Home/Industry/content/id/<?php echo ($d["id"]); ?>">
                    <?php echo (msubstr($d["title"],0,30,'utf-8',false)); ?></a></h4>
                    <p><?php echo (date("Y年m月d日",strtotime($d["time"]))); ?>&nbsp;/&nbsp;点击次数：<?php echo ($d["click"]); ?></p>
                  </div>
            ...
            <div class="new-company-btn">
                    ...
                    <a href="/shanghua/index.php/Home/Industry/content/id/<?php echo ($d["id"]); ?>" id="more1">查看更多&nbsp;>></a>
                  </div>
