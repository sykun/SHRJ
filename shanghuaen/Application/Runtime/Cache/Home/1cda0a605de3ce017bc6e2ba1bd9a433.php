...
<body>
  <div id="nav-header">
    ...
    <div id="nav-right">
      <p><a href="<?php echo U('New/content');?>">中文&nbsp;</a>|<a href="<?php echo U('New/contente');?>">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner" >
    ...
    <div id="content-foot">
      <ul>
        <li>上一篇：
            <?php if($prev == '没有了'): ?>没有了
                <?php else: ?>
                <a href="/shanghua/index.php/Home/New/content/id/<?php echo ($prev["id"]); ?>"><?php echo ($prev["title"]); ?></a><?php endif; ?>
        </li>
        <li>下一篇：
            <?php if($next == '没有了'): ?>没有了
                <?php else: ?>
                <a href="/shanghua/index.php/Home/New/content/id/<?php echo ($next["id"]); ?>"><?php echo ($next["title"]); ?></a><?php endif; ?>
        </li>
      </ul>
    </div>
  </div>
