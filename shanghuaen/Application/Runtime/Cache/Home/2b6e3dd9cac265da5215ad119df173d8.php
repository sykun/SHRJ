...
<head>
  ...
  <link href="/shanghua/Public/home/css/theme-style.css" rel='stylesheet' type='text/css' />
  <link href="/shanghua/Public/home/css/bootstrap.css" rel='stylesheet' type='text/css' />
  <script src="/shanghua/Public/home/js/jquery.min.js"></script>
  <link href="/shanghua/Public/home/css/zzsc.css" type="text/css" rel="stylesheet" />
  <script src="/shanghua/Public/home/js/zzsc.js"></script>
  <script type="text/javascript" src="js/jquery-1.8.3.min.js"></script>
  <script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
    </script>
  <link rel="stylesheet" href="/shanghua/Public/home/fonts/css/font-awesome.min.css">
  <script>
      $(function() {
        var pull    = $('#pull');
          menu    = $('nav ul');
...
<body>
  <div id="nav-header">
    ...
    <div id="nav-right">
      <p><a href="/shanghua/index.php/Home/Product/intergrade">中文&nbsp;</a>|<a href="/shanghua/index.php/Home/Product/intergradee">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
    <img src="/shanghua/Public/home/images/b5.png">
  </div>
  <div id="bread">
    <div id="bread-left">设计软件</div>
     <div id="bread-right"><a href="/shanghua/index.php/Home/Index/index">首页&nbsp;</a>>><a href="/shanghua/index.php/Home/Product/product">&nbsp;产品服务&nbsp;</a>>>&nbsp;PDMS风管阻力计算</div>
  </div>
     <div id="blog" class="blog">
      <div class="container">
        <h3>上华管廊设计Sh-Utp<label> </label></h3>
        <div class="blog-grids">
          <div class="col-md-4 blog-grid-row frist-row">
            <a class="post-pic"><img src="/shanghua/Public/home/images/product6.png" title="pic-name" /></a>
            <div class="artical-info">
              <div class="post-head">
                <div class="post-head-left">
                  <h4><a>总体介绍：</a></h4>
                  <p class="author">By <a> Shanghua</a></p>
                </div>
                <div class="post-head-right">
                  <span>17</span><label>December 2016</label>
                </div>
                <div class="clearfix"> </div>
              </div>
              <p class="post-text">上华软件针对立足于工程建设信息化领域，重点推进城市综合管廊（”共同沟”）建设建设，针对地下管廊建设规划设计复杂、施工难度大、运营管理及后期维护信息量大等困难，联合中冶京城、中国市政华北院等，结合国内设计、施工、运维现状，借鉴国外地区经验，通过软件技术实现地下管廊的设计与运营管理。 采用GIS技术与BIM技术相结合开发的数字化综合管廊运维系统，借鉴了国外先进的管廊运维管理经验，可以有效地实现综合管廊后期数字标准化运维管理。
              ...
              <div class="post-bottom">
                ...
                <div class="post-bottom-right">
                  产品星级：<i class="fa fa-star"> </i><i class="fa fa-star"> </i><i class="fa fa-star"> </i></i><i class="fa fa-star"> </i>
                </div>
                <div class="clearfix"> </div>
              </div>
            </div>
          ...
          <div class="col-md-4 artical-row2">
            <div class="artical-info">
              <div class="post-head post-head1">
                ...
                <div class="post-head-right post-head-right-C">
                  <span>20</span><label>December 2016</label>
                </div>
                <div class="clearfix"> </div>
              </div>
              <p class="post-text"> 上华软件立足于工程建设信息化领域，重点推进城市地下综合管廊建设建设（地下“高速公路”），针对地下管廊建设规划设计复杂、施工难度大、运营管理及后期维护信息量大等困难，结合国内设计、施工、运维现状，借鉴国外地区经验，通过软件技术实现地下管廊的设计，提高设计效益、便于施工运维。</p>
              <div class="post-bottom">
                <div class="post-bottom-left">    
                </div>
                <div class="post-bottom-right">
                 特点星级：<i class="fa fa-star"> </i><i class="fa fa-star"> </i><i class="fa fa-star"> </i>
                </div>
                <div class="clearfix"> </div>
              </div>
            </div>
            <div class="artical-info">
              <div class="post-head post-head1">
                ...
                <div class="post-head-right post-head-right-C">
                  <span>23</span><label>December 2016</label>
                </div>
                <div class="clearfix"> </div>
              </div>
              <p class="post-text"> 实现综合管廊工程进行方案、施工图设计；给水、雨水、污水、再生水、天然气、热力、电力、通信等工程管线在管廊中的设计；雨水、污水等入水口设计，纵断面图等；雨水管道综合管廊敷设设计；污水管综合管廊敷设设计；上华软件立足于工程建设信息化领域，重点推进城市地下综合管廊建设建设（地下“高速公路”），针对地下管廊建设规划设计复杂、施工难度大、运营管理及后期维护信息量大等困难，结合国内设计、施工、运维现状，借鉴国外地区经验，通过软件技术实现地下管廊的设计，提高设计效益、便于施工运维。</p>
              <div class="post-bottom">
                <div class="post-bottom-left">                  
                </div>
                <div class="post-bottom-right">
                  特点星级：<i class="fa fa-star"> </i><i class="fa fa-star"> </i><i class="fa fa-star"> </i><i class="fa fa-star"> </i><i class="fa fa-star"> </i>
                </div>
                <div class="clearfix"> </div>
              </div>
            </div>
          ...
          <div class="col-md-4 artical-row2">
            <div class="artical-info">
              <div class="post-head post-head1">
                ...
                <div class="post-head-right post-head-right-C">
                  <span>28</span><label>December 2016</label>
                </div>
                <div class="clearfix"> </div>
              </div>
              <p class="post-text"> 上华软件立足于工程建设信息化领域，重点推进城市地下综合管廊建设建设（地下“高速公路”），针对地下管廊建设规划设计复杂、施工难度大、运营管理及后期维护信息量大等困难，结合国内设计、施工、运维现状，借鉴国外地区经验，通过软件技术实现地下管廊的设计，提高设计效益、便于施工运维。</p>
            ...
            <div class="artical-info">
              <div class="post-head post-head1">
                ...
                <div class="post-head-right post-head-right-C">
                  <span>30</span><label>December 2016</label>
                </div>
                <div class="clearfix"> </div>
              </div>
              <p class="post-text"> 实现综合管廊工程进行方案、施工图设计；给水、雨水、污水、再生水、天然气、热力、电力、通信等工程管线在管廊中的设计；雨水、污水等入水口设计，纵断面图等；雨水管道综合管廊敷设设计；污水管综合管廊敷设设计；上华软件立足于工程建设信息化领域，重点推进城市地下综合管廊建设建设（地下“高速公路”），针对地下管廊建设规划设计复杂、施工难度大、运营管理及后期维护信息量大等困难，结合国内设计、施工、运维现状，借鉴国外地区经验，通过软件技术实现地下管廊的设计，提高设计效益、便于施工运维。</p>
              <div class="post-bottom">
                ...
                <div class="post-bottom-right">
                  特点星级：<i class="fa fa-star"> </i><i class="fa fa-star"> </i><i class="fa fa-star"> </i><i class="fa fa-star"> </i>
                </div>
                <div class="clearfix"> </div>
              </div>
            </div>
