...
<div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/shanghua/index.php/Admin/Honor/doEdit" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr><td>
                                <input type="hidden" name="id" value="<?php echo ($honor["id"]); ?>">
                            </td></tr>
                            <tr>
                                <th>荣誉证书：</th>
                                <td>
                                <img src="/shanghua/Public/<?php echo ($honor["thumb"]); ?>">
                                <input name="thumb" id="" type="file"></td>
                            </tr>
                            
                            <tr>
                                <th>所获荣誉描述：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($honor["content"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
