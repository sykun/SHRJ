            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/shanghua/index.php/Admin/Success/add"><i class="icon-font"></i>新增案例</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($success)): $i = 0; $__LIST__ = $success;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            <td><input type="checkbox" name="successId[]" id="checkbox" value="<?php echo ($data["success_id"]); ?>"><label for="checkbox"></label></td>
                            <td><?php echo ($data["title"]); ?></td>
                            <td><?php echo ($data["content"]); ?></td>
                            <td>
                                <a class="link-update" href="/shanghua/index.php/Admin/Success/edit/id/<?php echo ($data["id"]); ?>">修改</a>
                                <a class="link-del" href="/shanghua/index.php/Admin/Success/delete/successId/<?php echo ($data["id"]); ?>">删除</a>
                            </td>
