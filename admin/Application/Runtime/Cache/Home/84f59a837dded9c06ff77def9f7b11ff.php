...
<body>
  ...
  <div id="nav-header">
   ...
   <div class="nav">
    ...
    <div id="nav-right">
      <p><a href="zonghe.html">中文&nbsp;</a>|<a href="zonghe-en.html">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
    <img src="/shanghua/Public/home/images/b9.png">
  </div>
  <div id="bread">
    <div id="bread-left">产品服务</div>
      <div id="bread-right"><a href="index.html">首页&nbsp;</a>>><a href="intergrade.html">&nbsp;产品服务&nbsp;</a>>>&nbsp;PDMS综合材料自动排版</div>
  </div>
  

  <div class="product-content">
    <div class="product-v1">
      <h2>PDMS COMPOSITE MATERIAL AUTOMATIC TYPESETTING</h2>
      <h3>PDMS综合材料自动排版</h3>
    </div>
    <div class="product-v2">
      <div class="div-a">
        ...
        <h3>产品简介</h3>
        <p> PDMS是工厂设计软件，最主要的功能是三维管道设计。</p>
      </div>
      <div class="div-b">
        <img src="/shanghua/Public/home/images/zh5.png" width="100%"height="100%">  
      </div>
    </div>
    <div class="product-v3">
      ...
      <h3>总体介绍</h3><br/>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;
        PDMS是工厂设计软件，最主要的功能是三维管道设计。能自动 生成设备平面布置图、管道平面布置图、ISO图、综合材料表等。使 用中自动生成的ISO图比较完善，设备平面布置图一般有CAD生成， 管道平面布置图需要适量修改，综合材料表非常混乱， 需要人工手动排版（期间很容易出错），排版后由于各种原因经常需 要修改模型重新出材料，重新排版，因此需要大量时间。为了提高设 计质量和效率，利用EXCEL附属的VBA语言开发了“综合材料自动排版系统(Ver1.0)”。
      </p>
      <img src="/shanghua/Public/home/images/zh6.png" width="100%"height="100%"> 
    </div>
    <div class="product-v4">
      <h2>MAIN SCREENSHOT</h2>
      <h3>主界面截图</h3><br/>
      <img src="/shanghua/Public/home/images/zh1.png" width="47%"height="50%"> 
      <img src="/shanghua/Public/home/images/zh2.png" width="47%"height="50%"style="padding-left:3%">
    </div>
