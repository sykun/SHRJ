...
<body>
  ...
  <div id="nav-header">
   ...
   <div class="nav">
    ...
    <div id="nav-right">
      <p><a href="gl-cn.html">中文&nbsp;</a>|<a href="gl-en.html">&nbsp;English</a></p>
    </div>
  </div>
 <div id="nav-banner">
    <img src="/shanghua/Public/home/images/b14.png" >
  </div>
<div id="bread">
    <div id="bread-left">成功案例</div>
      <div id="bread-right"><a href="">首页&nbsp;</a>>><a href="gl-cn.html">&nbsp;成功案例&nbsp;</a>>>&nbsp;管廊</div>
  </div>
            ...
            <div class="wrap">
                <div class="image">
                    <div class="display front">
                        <img src="/shanghua/Public/home/images/01.png"style="width: 100%;
 height:100%;"  alt="" />
                    </div>
                    <div class="display back">
                        <h3>北京工业大学引进智慧管廊建设新技术交流培训研讨会</h3>
                    </div>
                </div>
            </div>
            <div class="wrap">
                <div class="image">
                    <div class="display front">
                        <img src="/shanghua/Public/home/images/02.png"style="width: 100%;
 height:100%;" alt="" />
                    </div>
                    <div class="display back">
                        <h3>北京建筑工程学院为城市规划建设做管理</h3>
                    </div>
                </div>
            </div>
            <div class="wrap">
                <div class="image">
                    <div class="display front">
                        <img src="/shanghua/Public/home/images/03.png" alt="" style="width: 100%;
 height:100%;"/>
                    </div>
                    <div class="display back">
                        <h3>北京建筑设计研究院引入上华软件新技术</h3>
                    </div>
                </div>
            </div>
            <div class="wrap">
                <div class="image">
                    <div class="display front">
                        <img src="/shanghua/Public/home/images/11.png" alt="" style="width: 100%;
 height:100%;"/>
                    </div>
                    <div class="display back">
                        <h3>青岛理工利用智慧管廊规划城市</h3>
                    </div>
                </div>
            </div>
            <div class="wrap">
                <div class="image">
                    <div class="display front">
                        <img src="/shanghua/Public/home/images/12.png" alt=""style="width: 100%;
 height:100%;" />
                    </div>
                    <div class="display back">
                        <h3>天津城建大学绿色建筑</h3>
            ...
            <div class="wrap">
                <div class="image">
                    <div class="display front">
                        <img src="/shanghua/Public/home/images/13.png" alt=""style="width: 100%;
 height:100%;" />
                    </div>
                    <div class="display back">
                        <h3>广州大学利用VE软件 新发现</h3>
                    </div>
                </div>
            </div>
        </div>
