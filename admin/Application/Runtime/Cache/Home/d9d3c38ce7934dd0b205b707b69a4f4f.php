...
<body>
  ...
  <div id="nav-header">
   ...
   <div class="nav">
    ...
    <div id="nav-right">
      <p><a href="fengli.html">中文&nbsp;</a>|<a href="fengli-en.html">&nbsp;English</a></p>
    </div>
  </div>
  <div id="nav-banner">
    <img src="/shanghua/Public/home/images/b10.png">
  </div>
  <div id="bread">
    <div id="bread-left">产品服务</div>
      <div id="bread-right"><a href="">首页&nbsp;</a>>><a href="intergrade_cn.html">&nbsp;产品服务&nbsp;</a>>>&nbsp;PDMS风管阻力计算</div>
  </div>
  
  <div class="product-content">
        <div class="product-v1">
            <h2>PDMS DUCT RESISTANCE CALCULATION</h2>
            <h3>PDMS风管阻力计算</h3>
        </div>
        <div class="product-v2">
            ...
            <div class="fr">
                ...
                <h3>软件介绍</h3><br/>
                <p>本软件基于BIM模型离线导航平台开发，本软件符合国内设计规范的计算功能；解决了国内现有的计算软件无法基于PDMS等BIM软件风管模型进行计算；现有的计算软件无完善的构件参数库。</p>  
            </div>
        </div>
