            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/new/create');?>"><i class="icon-font"></i>新增新闻</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($data["inputtime"]); ?></td>
                            <td><?php echo ($data["updatetime"]); ?></td>
                            <td>
                                <a class="link-update" href="<?php echo U('Admin/new/edit');?>/id/<?php echo ($data["id"]); ?>">修改</a>
