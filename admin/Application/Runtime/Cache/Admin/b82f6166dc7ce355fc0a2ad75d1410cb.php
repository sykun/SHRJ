...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/shanghua12/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">新闻列表</span></div>
        </div>
        <div class="result-wrap">
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/shanghua12/index.php/Admin/New/add"><i class="icon-font"></i>新增新闻</a>
                        ...
                        <a href="/shanghua12/index.php/Admin/New/search"><input type="button" value="搜索" /></a> -->
                        ...
                        <a href="/shanghua12/index.php/Admin/New/find"><input type="button" value="搜索" /></a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            <td><input type="checkbox" name="newsId[]" id="checkbox" value="<?php echo ($data["news_id"]); ?>"><label for="checkbox"></label></td>
                            <td><img src="/shanghua12/Public/<?php echo ($data["thumb"]); ?>" width="60px" height="60px"></td>
                            <td><?php echo ($data["title"]); ?></td>
                            <td><?php echo ($data["content"]); ?></td>
                            <td><?php echo ($data["time"]); ?></td>
                            <td><?php echo ($data["click"]); ?></td>
                            <td>
                                <a class="link-update" href="/shanghua12/index.php/Admin/New/edit/id/<?php echo ($data["id"]); ?>">修改</a>
                                <a class="link-del" href="/shanghua12/index.php/Admin/New/delete/newsId/<?php echo ($data["id"]); ?>">删除</a>
                            </td>
