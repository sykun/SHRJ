...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/shanghua3/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name"><a href="/shanghua3/index.php/Admin/Advice/lists">咨询管理</a></span><span class="crumb-step">&gt;</span><span class="crumb-name">最新咨询</span></div>
        </div>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($advice)): $i = 0; $__LIST__ = $advice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-del" href="/shanghua3/index.php/Admin/Advice/delete/adviceId/<?php echo ($data["id"]); ?>">删除</a>
                            </td>
