            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/meeting/create');?>"><i class="icon-font"></i>新增会议</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($meetings)): $i = 0; $__LIST__ = $meetings;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($data["title"]); ?>"><a target="_blank" href="#" title="<?php echo ($data["title"]); ?>"><?php echo ($data["title"]); ?></a> …
                            </td>
                            <td>2016-09-14</td>
                            <td>2016-09-14</td>
                            <td>
                                <a class="link-update" href="<?php echo U('Admin/meeting/edit');?>/id/<?php echo ($data["id"]); ?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/meeting/destory');?>/id/<?php echo ($data["id"]); ?>">删除</a>
                            </td>
