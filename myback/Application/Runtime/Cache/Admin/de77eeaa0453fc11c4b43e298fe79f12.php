            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <input type="text" id="searchall" /><input type="button" value="查询" id="searchall2"/>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($job)): $i = 0; $__LIST__ = $job;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                            <td><input type="checkbox" name="jobId[]" id="checkbox" value="<?php echo ($data["job_id"]); ?>"><label for="checkbox"></label></td>
                            <td><?php echo ($data["title"]); ?></td>
                            <td><?php echo ($data["time"]); ?></td>
                            <td><?php echo ($data["place"]); ?></td>
                            <td><?php echo ($data["num"]); ?></td>
                            <td><?php echo ($data["content"]); ?></td>
                            <td><?php echo ($data["demand"]); ?></td>
                            <td>
